...
export default function Portof() {
    return (
        <div id='portof' >
            ...
            <div className="container-grid " >
                ...
                <div className="imgright1 flex items-center justify-end" data-aos='fade-right'  data-aos-offset="-1000" data-aos-delay='170'  ><Card title={'Youtube Downloader'} created={'12 juli 2022'} image={ytdownloader}  link={'https://youtdownloader.vercel.app/'}/></div>
            </div>
        </div>
    )
}
